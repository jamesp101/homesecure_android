...
import com.example.homesecure.lists.DeviceActivity
...
//            throw RuntimeException(context.toString() + " must implement OnFragmentInteractionListener")
    ...
    private fun populateTimeline(view: View){
        ...
        val adapter = TimeLineAdapter(eventList)

        val timeline : RecyclerView = view.findViewById(R.id.recyclerTimeline)
        timeline.apply{
...
class TimeLineAdapter(private val feedList: List<Event>)
    :RecyclerView.Adapter<TimeLineAdapter.TimeLineViewHolder>()
{
    ...
    inner class TimeLineViewHolder
        ...
        public lateinit var mTimelineView: TimelineView
        init{
